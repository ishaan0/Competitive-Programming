...
int solve(){
    ...
    vector<int> s_low(30), s_up(30), t_low(30), t_up(30) ;
    foreach(s){
        if(isupper(val)) s_up[val-'A']++ ;
        else s_low[val-'a']++ ;
    }
    foreach(t){
        if(isupper(val)) t_up[val-'A']++ ;
        else t_low[val-'a']++ ;
    }
